...
namespace Zenject.SpaceFighter
{
    ...
    public class GameInstaller : MonoInstaller
    {
        ...
        public override void InstallBindings()
        {
            ...
            Container.BindFactory<float, float, BulletTypes, ZenjectBullet, ZenjectBullet.Factory>()
                // We could just use FromMonoPoolableMemoryPool here instead, but
                // for IL2CPP to work we need our pool class to be used explicitly here
                .FromPoolableMemoryPool<float, float, BulletTypes, ZenjectBullet, BulletPool>(poolBinder => poolBinder
        ...
        class BulletPool : MonoPoolableMemoryPool<float, float, BulletTypes, IMemoryPool, ZenjectBullet>
        {
        }
