...
namespace Zenject.SpaceFighter
{
    ...
    public class ZenjectBullet : MonoBehaviour, IPoolable<float, float, BulletTypes, IMemoryPool>
    {
        float _startTime;
        BulletTypes _type;
        float _speed;
        ...
        public class Factory : PlaceholderFactory<float, float, BulletTypes, ZenjectBullet>
        {
        }
    }
}
